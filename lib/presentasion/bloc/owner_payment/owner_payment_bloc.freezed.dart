...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OwnerPaymentEvent);
}
...
/// @nodoc
class $OwnerPaymentEventCopyWith<$Res>  {
$OwnerPaymentEventCopyWith(OwnerPaymentEvent _, $Res Function(OwnerPaymentEvent) __);
}


/// Adds pattern-matching-related methods to [OwnerPaymentEvent].
extension OwnerPaymentEventPatterns on OwnerPaymentEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String? status,  String? method,  int page)?  getList,TResult Function( int id)?  getDetail,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _GetList() when getList != null:
return getList(_that.status,_that.method,_that.page);case _GetDetail() when getDetail != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String? status,  String? method,  int page)  getList,required TResult Function( int id)  getDetail,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _GetList():
return getList(_that.status,_that.method,_that.page);case _GetDetail():
return getDetail(_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String? status,  String? method,  int page)?  getList,TResult? Function( int id)?  getDetail,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _GetList() when getList != null:
return getList(_that.status,_that.method,_that.page);case _GetDetail() when getDetail != null:
...
class _Started implements OwnerPaymentEvent {
  const _Started();
...
@override
String toString() {
  return 'OwnerPaymentEvent.started()';
}
...
class _GetList implements OwnerPaymentEvent {
  const _GetList({this.status, this.method, this.page = 1});
...
/// Create a copy of OwnerPaymentEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetList&&(identical(other.status, status) || other.status == status)&&(identical(other.method, method) || other.method == method)&&(identical(other.page, page) || other.page == page));
}


@override
int get hashCode => Object.hash(runtimeType,status,method,page);

@override
String toString() {
  return 'OwnerPaymentEvent.getList(status: $status, method: $method, page: $page)';
}
...
/// @nodoc
abstract mixin class _$GetListCopyWith<$Res> implements $OwnerPaymentEventCopyWith<$Res> {
  factory _$GetListCopyWith(_GetList value, $Res Function(_GetList) _then) = __$GetListCopyWithImpl;
@useResult
$Res call({
 String? status, String? method, int page
});
...
/// Create a copy of OwnerPaymentEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? status = freezed,Object? method = freezed,Object? page = null,}) {
...
class _GetDetail implements OwnerPaymentEvent {
...
@override
String toString() {
  return 'OwnerPaymentEvent.getDetail(id: $id)';
}
...
/// @nodoc
abstract mixin class _$GetDetailCopyWith<$Res> implements $OwnerPaymentEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OwnerPaymentState);
}
...
/// @nodoc
class $OwnerPaymentStateCopyWith<$Res>  {
$OwnerPaymentStateCopyWith(OwnerPaymentState _, $Res Function(OwnerPaymentState) __);
}


/// Adds pattern-matching-related methods to [OwnerPaymentState].
extension OwnerPaymentStatePatterns on OwnerPaymentState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OwnerPaymentModel> items,  OwnerPaymentMetaModel? meta)?  listLoaded,TResult Function( OwnerPaymentModel? item)?  detailLoaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OwnerPaymentModel> items,  OwnerPaymentMetaModel? meta)  listLoaded,required TResult Function( OwnerPaymentModel? item)  detailLoaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OwnerPaymentModel> items,  OwnerPaymentMetaModel? meta)?  listLoaded,TResult? Function( OwnerPaymentModel? item)?  detailLoaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _ListLoaded() when listLoaded != null:
...
class _Initial implements OwnerPaymentState {
  const _Initial();
...
@override
String toString() {
  return 'OwnerPaymentState.initial()';
}
...
class _Loading implements OwnerPaymentState {
  const _Loading();
...
@override
String toString() {
  return 'OwnerPaymentState.loading()';
}
...
class _ListLoaded implements OwnerPaymentState {
  const _ListLoaded( List<OwnerPaymentModel> items, this.meta): _items = items;
  

 final  List<OwnerPaymentModel> _items;
 List<OwnerPaymentModel> get items {
...
/// Create a copy of OwnerPaymentState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'OwnerPaymentState.listLoaded(items: $items, meta: $meta)';
}
...
/// @nodoc
abstract mixin class _$ListLoadedCopyWith<$Res> implements $OwnerPaymentStateCopyWith<$Res> {
  factory _$ListLoadedCopyWith(_ListLoaded value, $Res Function(_ListLoaded) _then) = __$ListLoadedCopyWithImpl;
@useResult
$Res call({
 List<OwnerPaymentModel> items, OwnerPaymentMetaModel? meta
});
...
as List<OwnerPaymentModel>,freezed == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as OwnerPaymentMetaModel?,
  ));
}
...
class _DetailLoaded implements OwnerPaymentState {
  const _DetailLoaded(this.item);
  

 final  OwnerPaymentModel? item;
...
@override
String toString() {
  return 'OwnerPaymentState.detailLoaded(item: $item)';
}
...
class _Error implements OwnerPaymentState {
...
@override
String toString() {
  return 'OwnerPaymentState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OwnerPaymentStateCopyWith<$Res> {
